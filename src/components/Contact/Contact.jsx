            ...
            <section id="contact" className="contact mt-5 mb-5">
                        ...
                        <div className="col-lg-4">
                            <div className="info rounded p-3" style={{ background: '#f8f9fa' }}>
                                <div className="d-flex mb-2 gap-2">
                                    ...
                                    <div>
                                        <h4>Location:</h4>
                                        <p>Khamgaon Road, SHEGAON – 444203, Dist. Buldhana (M.S.) INDIA</p>
                                    </div>
                                </div>
                ...
                <div>
                    <div className="container">
                        ...
                        <iframe style={{ border: 0, width: "100%", height: "350px" }} src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3730.267238517111!2d76.67545147502426!3d20.780473780807466!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd7457296aaba57%3A0xa9f05c70098ee6c7!2sShri%20Sant%20Gajanan%20Maharaj%20College%20Of%20Engineering!5e0!3m2!1sen!2sin!4v1713218507108!5m2!1sen!2sin" width="600" height="450"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </section>
            <Footer />
